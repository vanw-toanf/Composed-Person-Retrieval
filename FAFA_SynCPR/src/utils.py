...
from data_utils import ITCPRDataset, GalleryDataset, QueryDataset
...
def extract_index_blip_features(dataset, blip_model, save_memory=False) -> \
        Tuple[torch.tensor, List[str]]:
    """
    Extract index features
    :param dataset: Dataset in 'classic' mode
    :param blip_model: BLIP model
    :param save_memory: Whether to save memory
...
def save_model(name: str, iteration: int, model_to_save: nn.Module, training_path: Path, mode='epoch'):
    """
