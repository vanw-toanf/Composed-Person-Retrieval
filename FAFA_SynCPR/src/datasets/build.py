...
from .comreid import ITCPRDataset

__factory = {'CUHK-PEDES': CUHKPEDES, 'ICFG-PEDES': ICFGPEDES, 'RSTPReid': RSTPReid, 'ITCPRDataset': ITCPRDataset}
...
def build_dataloader_toword(args, tranforms=None):
    num_workers = args.num_workers
    dataset = __factory['ITCPRDataset'](root='/data1')
    # num_classes = len(dataset.train_id_container)
