...
source_dir = 'data_raw/last'  # Path to the original directory
dest_dir = 'dataset/last'  # Path to the new directory
...
base_dir = 'data_raw/Celeb-reID'  # Path to the Celeb-reID folder
subfolders = ['gallery', 'query', 'train']# List of subfolders
new_dir = 'dataset/Celeb-reID' # Path to the new directory
